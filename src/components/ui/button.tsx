  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white font-semibold shadow-elegant hover:shadow-glow hover:scale-105 transition-bounce",
        gradient: "gradient-primary text-white font-medium shadow-card hover:shadow-elegant hover:scale-102 transition-smooth",
        accent: "gradient-accent text-white font-medium shadow-card hover:shadow-elegant",
      },
      size: {
